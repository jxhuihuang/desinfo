...
let {filter, checkNull, indexof, jwtVerify}=require('../../common/untils');
    ...
    jwtVerify(req, jwt,function(decode){
        switch (_methods){
            ...
            case "insert":
                ...
                params.reporter_id=decode.id;
                params.report_unit_name=params.report_unit_name?params.report_unit_name:decode.dept; 
                params.reporting_unit_category=params.reporting_unit_category?params.reporting_unit_category:decode.unit_category; //报告单位类型
                mysql.findAndCountAll({
