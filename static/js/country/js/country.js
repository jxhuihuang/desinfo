...
function(t){
    ...
    {
        key: 'H',
        data: ['HT|海地', 'KR|韩国', 'KZ|哈萨克斯坦', 'HM|赫德岛和麦克唐纳群岛', 'ME|黑山', 'NL|荷兰', 'BQ|荷兰加勒比区', 'HN|洪都拉斯']
    },
    {
        key: 'J',
    ...
    {
        key: 'Z',
        data: ['ZM|赞比亚', 'JE|泽西岛', 'TD|乍得', 'GI|直布罗陀', 'CL|智利', 'CF|中非', 'CN|中国']
    }]
    var hotCity = ['CN|中国', 'US|美国', 'GB|英国', 'FR|法国', 'JP|日本', 'CA|加拿大', 'AU|澳大利亚', 'RU|俄罗斯', 'DE|德国', 'IN|印度', 'KR|韩国'] 
    ...
    t.fn.country=function(obj){
        var body_heights=document.body.clientJeight;
        var htmls=init();
        $(this).html(htmls)
